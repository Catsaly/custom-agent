...
export const MODELS: Record<string, ModelInfo> = {
  ...
  // Gemini
  "gemini-2.0-flash":            { id: "gemini-2.0-flash",            display: "Gemini 2.0 Flash",           short: "Gemini 2.0",      provider: "gemini",      free: true,  icon: "💎", color: "#4285f4", group: "Gemini" },
  "gemini-2.0-flash-exp":        { id: "gemini-2.0-flash-exp",        display: "Gemini 2.0 Flash Exp",       short: "Gemini 2.0 Exp",  provider: "gemini",      free: true,  icon: "💎", color: "#4285f4", group: "Gemini" },
  ...
  "gemma2-9b-it":                { id: "gemma2-9b-it",                display: "Gemma 2 9B (Groq)",          short: "Gemma 2 9B",      provider: "groq",        free: true,  icon: "🦙", color: "#7c3aed", group: "Groq" },
  ...
  // OpenRouter
  "google/gemini-2.0-flash-exp:free":               { id: "google/gemini-2.0-flash-exp:free",               display: "Gemini 2.0 Flash (OR)",      short: "Gemini 2.0",      provider: "openrouter",  free: true,  icon: "🌐", color: "#059669", group: "OpenRouter" },
  "meta-llama/llama-3.3-70b-instruct:free":         { id: "meta-llama/llama-3.3-70b-instruct:free",         display: "Llama 3.3 70B (OR)",         short: "Llama 3.3 70B",   provider: "openrouter",  free: true,  icon: "🌐", color: "#059669", group: "OpenRouter" },
  "deepseek/deepseek-chat-v3-0324:free":            { id: "deepseek/deepseek-chat-v3-0324:free",            display: "DeepSeek V3 (OR)",            short: "DeepSeek V3",     provider: "openrouter",  free: true,  icon: "🌐", color: "#059669", group: "OpenRouter" },
  ...
  "qwen/qwq-32b:free":                              { id: "qwen/qwq-32b:free",                              display: "QwQ 32B (OR)",                short: "QwQ 32B",         provider: "openrouter",  free: true,  icon: "🌐", color: "#059669", group: "OpenRouter" },
  ...
  "microsoft/phi-4:free":                           { id: "microsoft/phi-4:free",                           display: "Phi-4 (OR)",                  short: "Phi-4",           provider: "openrouter",  free: true,  icon: "🌐", color: "#059669", group: "OpenRouter" },
  "mistralai/mistral-small-3.1-24b-instruct:free":  { id: "mistralai/mistral-small-3.1-24b-instruct:free",  display: "Mistral Small 3.1 24B (OR)", short: "Mistral Small",   provider: "openrouter",  free: true,  icon: "🌐", color: "#059669", group: "OpenRouter" },
};
